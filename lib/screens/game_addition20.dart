...
/// ➕ GameAddition20Screen v7.0 — Fintech Gradient + Confetti + Shimmer Glow
...
class _GameAddition20ScreenState extends State<GameAddition20Screen>
  ...
  static const String progressKey = "game_addition20_progress";
  static const String completedKey = "game_addition20_completed";
  ...
  Future<void> _onCompleted() async {
    ...
    await _play("victory");
    await ProgressService.markLevelCompleted("addition20");
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ShaderMask(
                      ...
                      child: const Text(
                        "Bé đã hoàn thành 10 phép cộng ≤20! 🌟",
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color:
                              const Color(0xFF5E2CED).withOpacity(0.4),
                              blurRadius: 20,
