...
class GameDivision extends StatefulWidget {
  const GameDivision({super.key});
  @override State<GameDivision> createState() => _GameDivisionState();
}

class _GameDivisionState extends State<GameDivision> {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Game Chia")),
      body: Stack(children:[
