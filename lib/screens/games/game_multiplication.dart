...
class GameMultiplication extends StatefulWidget {
  const GameMultiplication({super.key});
  @override State<GameMultiplication> createState() => _GameMultiplicationState();
}

class _GameMultiplicationState extends State<GameMultiplication> {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Game Nhân")),
      body: Stack(children:[
